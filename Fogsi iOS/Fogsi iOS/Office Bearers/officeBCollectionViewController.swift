//
//  officeBCollectionViewController.swift
//  Fogsi iOS
//
...
class officeBCollectionViewController: UICollectionViewController,UICollectionViewDelegateFlowLayout {
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "officeBCollectionViewCell", for: indexPath) as! officeBCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if let collection = self.collectionviewOfficeB{
